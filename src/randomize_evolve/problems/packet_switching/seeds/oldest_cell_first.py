"""Oldest-cell-first baseline for packet-switching evaluation."""
...
class OldestCellFirstScheduler:
    """Exact age-priority matching over head-of-line VOQ cell ages."""
    ...
    def select_matches(
        ...
        """Return a matching that prioritizes the oldest visible cells."""
    ...
    def _edge_weight(
        ...
        return self.AGE_MULTIPLIER * age + backlog
...
def candidate_factory(ports: int) -> OldestCellFirstScheduler:
    """Build the oldest-cell-first baseline."""

    return OldestCellFirstScheduler(ports, ports)
