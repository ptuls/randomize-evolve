...
CUCKOO_SEED = {
    "description": "Cuckoo-inspired filter with displacement",
    "program": """
    import hashlib
...
QUOTIENT_SEED = {
    "description": "Counting filter with quotients",
    "program": """
    import hashlib
...
def available_seeds():
    """Return a mapping of seed identifiers to descriptions and code."""
